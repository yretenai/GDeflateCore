...
namespace GDeflate
{
    ...
    extern "C" size_t GDeflateCompressBound(size_t size)
    {
    ...
    extern "C" bool GDeflateCompress(uint8_t* output, size_t* outputSize, const uint8_t* in, size_t inSize, uint32_t level, uint32_t flags)
    {
