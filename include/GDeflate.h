...
namespace GDeflate
{
    ...
    extern "C" GDEFLATE_SHARED size_t GDeflateCompressBound(size_t size);

    extern "C" GDEFLATE_SHARED bool GDeflateCompress(
        uint8_t* output,
        size_t* outputSize,
        const uint8_t* in,
        size_t inSize,
    ...
    extern "C" GDEFLATE_SHARED bool GDeflateDecompress(uint8_t* output, size_t outputSize, const uint8_t* in, size_t inSize, uint32_t numWorkers);
